// Vercel relay for MicroStudio's Gemini Key Pool.
// The Next.js app sends OpenAI-compatible chat completions here; this function
// forwards them to Gemini's generateContent with the Gemini key, so Gemini sees
...
//  - Gemini keys pass through in the Authorization header; they are never stored here.
