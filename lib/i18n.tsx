...
const D: Dict = {
  ...
  adminAnalytics: { en: "Analytics", id: "Analitik" },
  totalRequests: { en: "Total requests", id: "Total permintaan" },
  totalImagesSuccess: { en: "Images success", id: "Gambar sukses" },
  totalImagesFailed: { en: "Images failed", id: "Gambar gagal" },
  totalTokensIn: { en: "Tokens in", id: "Token masuk" },
  totalTokensOut: { en: "Tokens out", id: "Token keluar" },
  requestsChart: { en: "Requests · Success · Failed", id: "Permintaan · Sukses · Gagal" },
  tokensChart: { en: "Tokens in · Tokens out", id: "Token masuk · Token keluar" },
  averages: { en: "Averages", id: "Rata-rata" },
  ...
  fLangs: { en: "One image, multi language", id: "Satu foto, multi bahasa" },
  fLangsD: { en: "English · Deutsch · العربية — one analysis, titles & keywords for every market at once.", id: "Inggris · Jerman · Arab — satu analisis, judul & kata kunci untuk setiap pasar sekaligus." },
